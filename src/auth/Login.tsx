...
function Login() {
  return (
    <div className="bg-no-repeat bg-cover bg-center relative">
      <div className="absolute bg-gradient-to-b from-indigo-900 to-indigo-800 inset-0 z-0"></div>
      <div className="min-h-screen sm:flex sm:flex-row mx-0 justify-center">
        <div className="flex-col flex  self-center p-10 sm:max-w-5xl xl:max-w-2xl  z-10">
          <div className="self-start hidden lg:flex flex-col  text-white">
            <img src="" className="mb-3" />
            <h1 className="mb-3 font-bold text-5xl">
              Hi ? Welcome Back Charls{' '}
            </h1>
            <p className="pr-3">
          ...
          <div className="p-12 bg-white mx-auto rounded-2xl w-100 ">
            ...
            <div className="space-y-5">
              ...
              <div className="space-y-2">
                ...
                <input
                  className="w-full content-center text-base px-4 py-2 border  border-gray-300 rounded-lg focus:outline-none focus:border-indigo-400"
                  type=""
            ...
            <div className="pt-5 text-center text-gray-400 text-xs">
              <span>Copyright © 2021-2022 Charls</span>
            </div>
          </div>
        </div>
      </div>
